...
describe('Classification e2e test', () => {
  ...
  describe('Classification page', () => {
    ...
    describe('with existing value', () => {
      ...
      it('edit button click should load edit Classification page and go back', () => {
      ...
      it('edit button click should load edit Classification page and save', () => {
        cy.get(entityEditButtonSelector).first().click();
        cy.getEntityCreateUpdateHeading('Classification');
  ...
  describe('new Classification page', () => {
    ...
    it('should create an instance of Classification', () => {
      cy.get(`[data-cy="code"]`).type('scalable').should('have.value', 'scalable');

      cy.get(`[data-cy="score"]`).should('not.be.checked');
      cy.get(`[data-cy="score"]`).click().should('be.checked');
