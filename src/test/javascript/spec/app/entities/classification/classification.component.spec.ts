...
describe('Component Tests', () => {
  describe('Classification Management Component', () => {
    ...
    it('should not load a page if the page is the same as the previous page', () => {
      // GIVEN
      classificationServiceStub.retrieve.reset();
      comp.previousPage = 1;
      ...
      // THEN
      expect(classificationServiceStub.retrieve.called).toBeFalsy();
    });
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(classificationServiceStub.retrieve.callCount).toEqual(3);
