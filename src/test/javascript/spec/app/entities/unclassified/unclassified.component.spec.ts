...
describe('Component Tests', () => {
  describe('Unclassified Management Component', () => {
    ...
    it('should not load a page if the page is the same as the previous page', () => {
      // GIVEN
      unclassifiedServiceStub.retrieve.reset();
      comp.previousPage = 1;
      ...
      // THEN
      expect(unclassifiedServiceStub.retrieve.called).toBeFalsy();
    });
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(unclassifiedServiceStub.retrieve.callCount).toEqual(3);
